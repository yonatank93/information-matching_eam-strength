# FIM-Matching for EAM potential fitted to DFT data
...
* *configs* - Containing the scripts, configuration, and ground truth related to candidate
  configurations.
* *data* - Containing target covariance, original EAM parameters, and other additional
