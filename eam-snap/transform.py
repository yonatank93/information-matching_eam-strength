...
class EAMTransform(TransformBase):
    ...
    def __init__(self,
        ...
        super().__init__(params0_file=params0,
                         tmp_dir=tmp_dir,
    ...
    def inverse_transform(self, params):
        ...
        if self.subdir is None:
            ...
            if self.subdir == "random":
                ...
                subdir = self.subdir
            target_dir = self.TMP_DIR / subdir
        ...
        self._write_eam_alloy_file(params_20vals, target_dir)
        # Read parameter file and extract the parameter values
        eam_data = self.read_eam_alloy(target_dir)
        values = []
        ...
        if self.cleanup:
            ...
            self.cleanup_tmp_dir(target_dir)
    ...
    def read_eam_alloy(self, target_dir):
        ...
        atomic_num, atomic_mass, lattice_const, crystal_structure = lines[
            metadata_end + 2].split()
